...
def main():
    ...
    if True:
        ...
        # bulb1 = WifiLedBulb('192.168.0.142')
        # bulb2 = WifiLedBulb('192.168.0.193')
        # bulb3 = WifiLedBulb('192.168.0.246')
        # bulb4 = WifiLedBulb('192.168.0.113')
        # bulb5 = WifiLedBulb('192.168.0.130')
        # bulb6 = WifiLedBulb('192.168.0.118')
        # bulb7 = WifiLedBulb('192.168.0.176')
        # bulb8 = WifiLedBulb('192.168.0.238')
        ...
        while True:
            ...
            # (use non-persistent mode to help preserve flash)
            bulb1.setRgb(*color, persist=False)
            ...
            crossFade(bulb1, color, next_color)
